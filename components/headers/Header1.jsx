...
import { GetNftCookieToken, SearchAction } from "@/actions/axios/nft.axios";
                    ...
                    {Searchdata.token?.data?.length > 0 && (
                      <div className="content">
                        ...
                        {Searchdata.token?.data.map((value) => (
                          <>
                            <div
                              className="searchset pt-4 searchCursor cursor-pointer"
                              onClick={() => {
                                Setval("");
                                SetSearch();
                                push(
                                  `/item/${value.ContractAddress}/${value.NFTOwner}/${value.NFTId}`
                                );
                              }}
                            >
                              <div className="">
